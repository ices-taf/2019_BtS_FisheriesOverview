...
ggplot2::ggsave("BtS_CatchCommonName5.png", path = "~/", width = 178, height = 130, units = "mm", dpi = 300)

        #data
plot_dat <-plot_catch_trends(catch_dat, type = "COMMON_NAME", line_count = 5, plot_type = "line", return_data = T)
write.csv(plot_dat, file= "BtS_catchby_commonname.csv")
