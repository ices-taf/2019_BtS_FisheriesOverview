...
write.taf("2019_BtS_FO_Figure5.csv", dir = "report")
...
ggplot2::ggsave("2019_BtS_FO_Figure2.png", path = "~/", width = 178, height = 130, units = "mm", dpi = 300)

        #data
plot_dat<-plot_catch_trends(catch_dat, type = "COUNTRY", line_count = 9, plot_type = "area", return_data = T)
write.taf(plot_dat, file= "2019_BtS_FO_Figure2.csv", dir = "report")
...
ggplot2::ggsave("2019_BtS_FO_Figure4.png", path = "~/", width = 178, height = 130, units = "mm", dpi = 300)
        
        #data
plot_dat <- plot_catch_trends(catch_dat, type = "GUILD", line_count = 4, plot_type = "line", return_data = T)
write.taf(plot_dat, file= "2019_BtS_FO_Figure4.csv", dir = "report")
...
#~~~~~~~~~~~~~~~#
        #Plot
plot_stecf(frmt_effort,"COUNTRY", "2019","August", 9, "15-23")
ggplot2::ggsave("2019_BtS_FO_Figure3.png", path = "~/", width = 178, height = 130, units = "mm", dpi = 300)
        #data
plot_dat <- plot_stecf(frmt_effort,"COUNTRY", "2019","August", 9, "15-23", return_data = TRUE)
write.taf(plot_dat, file= "2019_BtS_FO_Figure3.csv", dir = "report")
...
#~~~~~~~~~~~~~~~#
        #Plot
plot_stecf(frmt_effort,"GEAR", "2019","August", 9, "15-23")
ggplot2::ggsave("2019_BtS_FO_Figure8.png", path = "~/", width = 178, height = 130, units = "mm", dpi = 300)

        #data
plot_dat<-plot_stecf(frmt_effort,"GEAR", "2019","August", 9, "15-23", return_data = TRUE)
write.taf(plot_dat, file= "B2019_BtS_FO_Figure8.csv", dir = "report")

#~~~~~~~~~~~~~~~#
#Landings by country
#~~~~~~~~~~~~~~~#
        #Plot
plot_stecf(frmt_landings,"GEAR", "2019","August", 9, "15-23")
ggplot2::ggsave("2019_BtS_FO_Figure6.png", path = "~/", width = 178, height = 130, units = "mm", dpi = 300)
        #dat
plot_dat<- plot_stecf(frmt_landings,"landings", variable, "2019","August", 9, "15-23", return_data = TRUE)
write.taf(plot_dat, file= "2019_BtS_FO_Figure6.csv", dir = "report")
...
png(paste0(output_path, "2019_BtS_FO_Figure13_demersal", ".png"),
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
png(paste0(output_path, "2019_BtS_FO_Figure13_pelagic", ".png"),
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
png(paste0(output_path, "2019_BtS_FO_Figure13_benthic", ".png"),
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
png(paste0(output_path, "2019_BtS_FO_Figure13_All", ".png"),
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
write.csv(plot_dat, file ="2019_BtS_FO_Figure7_trends.csv", dir = "report" )
...
write.taf(plot_dat, file ="2019_BtS_FO_Figure7_current.csv", dir = "report" )

png(paste0(output_path, "2019_BtS_FO_Figure7", ".png"),
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
ggplot2::ggsave("2019_BtS_FO_Figure10.png", path = "~/", width = 178, height = 178, units = "mm", dpi = 300)

plot_dat <- plot_status_prop_pies(frmt_status, "November", "2018", return_data = T)
write.taf(plot_dat, file= "2019_BtS_FO_Figure10.csv", dir = "report")
...
ggplot2::ggsave("2019_BtS_FO_Figure11.png", path = "~/", width = 178, height = 178, units = "mm", dpi = 300)

plot_dat <- plot_GES_pies(frmt_status, catch_current, "November", "2018", return_data = T)
write.taf(plot_dat, file= "2019_BtS_FO_Figure11.csv", dir = "report")

#~~~~~~~~~~~~~~~#
#F. ANNEX TABLE 
#~~~~~~~~~~~~~~~#
doc <- format_annex_table(frmt_status, 2019, return_data = F)
print(doc, target = paste0("~/", "2019_BtS_FO_annex_table", ".docx"))
